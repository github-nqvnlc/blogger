...
export function RichContent({
  ...
  return (
    <div
      className={cn(
        'whitespace-pre-wrap text-sm leading-7 break-words sm:text-base',
        className,
      )}
    >
      {value}
