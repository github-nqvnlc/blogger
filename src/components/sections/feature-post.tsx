    ...
    <div className="l-section-content">
      {!!posts && posts?.length > 0 ? (
        <div className="inner">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 my-8 md:my-12">
              ...
              <a href={`/blog/${posts?.[0].slug}`}>
                <div className="cursor-pointer group">
                  ...
                  <div className="my-5 space-y-4">
                    <div className="font-bold text-blue-muted text-xl md:text-3xl">
                      {posts?.[0].title}
                    </div>
                ...
                {posts?.slice(1, 4).map((post, index) => (
                  <a href={`/blog/${post.slug}`} key={post.name ?? index}>
                    <div className="flex gap-6">
                      <div className="relative h-24 w-24 sm:h-36 sm:w-36 shrink-0 overflow-hidden rounded-3xl">
                        <img
                          src={
                            post.thumb
                      ...
                      <div className="flex flex-1 flex-col space-y-2">
                        <span className="text-base sm:text-xl font-bold text-blue-muted leading-snug">
                          {post.title}
                        </span>
